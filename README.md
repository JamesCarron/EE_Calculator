...
docs/private/          plans, specs and task summaries - gitignored, a junction to a folder outside the checkout
...
- `docs/private/` — plans, specs and task summaries, including `Refactor_Plan.md`; gitignored, a directory junction to a folder held outside the checkout, so it is never part of a clone.
