...
Verified by round-tripping every table row: see eecalc_iec_tests.js.

Usage: python eecalc_iec60664_transcribe.py  (prints the JS to stdout)
"""
...
SRC = Path(r"C:\Auterion\Tools\EE_Calculator\test\.work\iec60664.cpp")
